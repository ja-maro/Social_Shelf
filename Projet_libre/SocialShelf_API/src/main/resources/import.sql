...
INSERT INTO `social_shelf`.`game` (`id`, `average_duration`, `creation_date`, `description`, `max_player`, `min_player`, `name`, `publisher`, `updated_date`) VALUES ('2', '45', '2022-10-01 14:49:26', 'Dans 7 Wonders Nouvelle Edition, prenez la tête de l\'une des sept grandes cités du monde antique et laissez votre empreinte dans l\'histoire des civilisations.', '7', '3', '7 Wonders', 'Repos Production', '2022-10-01 14:49:26');
