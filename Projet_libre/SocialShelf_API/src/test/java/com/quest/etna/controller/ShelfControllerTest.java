...
public class ShelfControllerTest {
	...
	public void testGetShelf() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get(CONTROLLER_PATH).header("Authorization", "Bearer " + token))
	...
	public void testAddToShelf() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.put(CONTROLLER_PATH + "/2").header("Authorization", "Bearer " + token))
		.andExpect(status().isOk());
	...
	public void testRemoveFromShelf() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete(CONTROLLER_PATH + "/1").header("Authorization", "Bearer " + token))
		.andExpect(status().isOk());
